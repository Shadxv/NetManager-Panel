...
export const Avatar = ({ src, size, alt = "avatar" }: AvatarProps) => {
    return (
        <div
            className={`relative overflow-hidden rounded-full bg-white shrink-0 shadow-sm shadow-primary-black/10 flex items-center justify-center ${size} ${src ? "" : "outline-2 outline-secondary-gray/20"}`}
        >
            {src ? (
                <Image
                    src={src}
                ...
                <svg
                    ...
                    className="text-secondary-gray/40"
                >
                    <path
